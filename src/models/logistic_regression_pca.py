...
from src.models.svm_tuned import accuracy
...
# PCA: keep components to explain 85% of variance
...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'model_jsons', 'logistic_pca')
